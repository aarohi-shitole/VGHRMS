...
@SQLDelete(sql = "UPDATE appraisal_evaluation_parameter SET status='D' WHERE id=?")
@Where(clause = "status != 'D'")
public class AppraisalEvaluationParameter extends BaseEntity implements Serializable {
