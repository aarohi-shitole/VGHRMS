...
/**
 * Criteria class for the {@link com.techvg.hrms.domain.WorkDaysSetting} entity. This class is used
 * in {@link com.techvg.hrms.web.rest.WorkDaysSettingResource} to receive all the possible filtering options from
...
public class WorkDaysSettingCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, day, hours, dayOff, status, companyId, lastModified, lastModifiedBy, distinct);
    }
