 ...
 * com.techvg.hrms.security.jwt.JWTFilter; import
 * com.techvg.hrms.security.jwt.TokenProvider; import
 * com.techvg.hrms.web.rest.vm.LoginVM; import javax.validation.Valid; import
 ...
 * @RestController
 * 
 * @RequestMapping("/api") public class UserJWTController {
 * 
 ...
 * this.tokenProvider = tokenProvider; this.authenticationManagerBuilder =
 * authenticationManagerBuilder; }
 * 
 * @PostMapping("/authenticate") public ResponseEntity<JWTToken>
 * authorize(@Valid @RequestBody LoginVM loginVM) {
 ...
 *//**
	 ...
	 *//*
		 ...
		 * 
		 * @JsonProperty("id_token") String getIdToken() { return idToken; }
		 * 
