...
public class PublicUserResource {
	...
	public ResponseEntity<List<AdminUserDTO>> getAllPublicUsers(
...
//
	...
	public ResponseEntity<List<AdminUserDTO>> getAllUsers(AdminUserCriteria criteria,
			@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
	...
	public ResponseEntity<List<AdminUserDTO>> getAllActiveUsers(
			@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
		log.debug("REST request to get all public User names");
