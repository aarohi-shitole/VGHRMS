...
public class EducationResource {
	 ...
	 *         body the new educationDTO, or with status {@code 400 (Bad Request)}
	 *         if the education has already an ID.
	...
	public ResponseEntity<EducationDTO> createEducation(@RequestBody EducationDTO educationDTO)
		...
		return ResponseEntity
				.created(new URI("/api/educations/" + result.getId())).headers(HeaderUtil
	 ...
	 *         the updated educationDTO, or with status {@code 400 (Bad Request)} if
	 *         the educationDTO is not valid, or with status
	 *         {@code 500 (Internal Server Error)} if the educationDTO couldn't be
	 *         updated.
	 * @throws URISyntaxException if the Location URI syntax is incorrect.
	 */
	@PutMapping("/educations/{id}")
	public ResponseEntity<EducationDTO> updateEducation(@PathVariable(value = "id", required = false) final Long id,
			@RequestBody EducationDTO educationDTO) throws URISyntaxException {
	...
	/**
	 * {@code PATCH  /educations/:id} : Partial updates given fields of an existing
	 * education, field will ignore if it is null
	 *
	 * @param id           the id of the educationDTO to save.
	 * @param educationDTO the educationDTO to update.
	 * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
	 *         the updated educationDTO, or with status {@code 400 (Bad Request)} if
	 *         the educationDTO is not valid, or with status {@code 404 (Not Found)}
	 *         if the educationDTO is not found, or with status
	 *         {@code 500 (Internal Server Error)} if the educationDTO couldn't be
	 *         updated.
	 * @throws URISyntaxException if the Location URI syntax is incorrect.
	 */
	...
	public ResponseEntity<EducationDTO> partialUpdateEducation(
			@PathVariable(value = "id", required = false) final Long id, @RequestBody EducationDTO educationDTO)
			throws URISyntaxException {
		...
		return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, true,
				ENTITY_NAME, educationDTO.getId().toString()));
	}
	 ...
	 *         of educations in body.
	 */
	@GetMapping("/educations")
	public ResponseEntity<List<EducationDTO>> getAllEducations(EducationCriteria criteria,
	 ...
	 * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
	 *         the educationDTO, or with status {@code 404 (Not Found)}.
	 */
