...
import com.techvg.hrms.service.SalaryQueryService;
import com.techvg.hrms.service.SalaryService;
...
/**
 * REST controller for managing {@link com.techvg.hrms.domain.Salary}.
 */
@RestController
@RequestMapping("/api")
public class SalaryResource {
    ...
    public SalaryResource(SalaryService salaryService, SalaryRepository salaryRepository, SalaryQueryService salaryQueryService) {
    ...
    @PostMapping("/salaries-employee")
    public void createSalary(@RequestParam Long empId) throws URISyntaxException {
        log.debug("REST request to save Salary");

        if (!employeeRepository.existsById(empId)) {
            throw new BadRequestAlertException("Employee Entity not found", ENTITY_NAME, "idnotfound");
        }
        salaryHelper.saveSalaryComponentsInSalary(empId);
    }
}
