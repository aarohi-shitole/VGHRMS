...
import com.techvg.hrms.repository.DepartmentRepository;
import com.techvg.hrms.service.DepartmentQueryService;
import com.techvg.hrms.service.DepartmentService;
...
/**
 * REST controller for managing {@link com.techvg.hrms.domain.Department}.
 */
@RestController
@RequestMapping("/api")
public class DepartmentResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/department/{id}", consumes = { "application/json", "application/merge-patch+json" })
    ...
    /**
     * {@code GET  /department/count} : count all the departments.
     *
     * @param criteria the criteria which the requested entities should match.
    ...
    /**
     * {@code DELETE  /department/:id} : delete the "id" department.
     *
