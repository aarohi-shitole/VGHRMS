...
import com.techvg.hrms.service.PersonalDetailHelper;
import com.techvg.hrms.service.PersonalDetailsQueryService;
import com.techvg.hrms.service.PersonalDetailsService;
import com.techvg.hrms.service.criteria.PersonalDetailsCriteria;
...
/**
 * REST controller for managing {@link com.techvg.hrms.domain.PersonalDetails}.
 */
@RestController
@RequestMapping("/api")
public class PersonalDetailsResource {
     ...
     *         body the new personalDetailsDTO, or with status
     *         {@code 400 (Bad Request)} if the personalDetails has already an ID.
    ...
    public ResponseEntity<PersonalDetailsDTO> createPersonalDetails(@RequestBody PersonalDetailsDTO personalDetailsDTO)
        ...
        personalDetailHelper.saveRetirementDate(result);
     ...
     *         the updated personalDetailsDTO, or with status
     *         {@code 400 (Bad Request)} if the personalDetailsDTO is not valid, or
     *         with status {@code 500 (Internal Server Error)} if the
     *         personalDetailsDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    /**
     * {@code PATCH  /personal-details/:id} : Partial updates given fields of an
     * existing personalDetails, field will ignore if it is null
     *
     * @param id                 the id of the personalDetailsDTO to save.
     * @param personalDetailsDTO the personalDetailsDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     *         the updated personalDetailsDTO, or with status
     *         {@code 400 (Bad Request)} if the personalDetailsDTO is not valid, or
     *         with status {@code 404 (Not Found)} if the personalDetailsDTO is not
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     *         the personalDetailsDTO, or with status {@code 404 (Not Found)}.
     */
